...
def render():
    ...
    if READINGS:
        ...
        readings_html = '<p class="reading-empty">Notes from recent reading will appear here.</p>'
...
<head>
  ...
  <meta name="theme-color" content="#faf8f3"><meta name="referrer" content="strict-origin-when-cross-origin">

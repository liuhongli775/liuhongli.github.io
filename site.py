...
<body id="top">
  ...
  <div class="academic-folio">
    ...
    <div class="folio-workspace">
      ...
      <button type="button" class="edge-turn edge-prev js-only" data-page-turn="-1" aria-label="Previous page"><span aria-hidden="true">←</span></button>
      <button type="button" class="edge-turn edge-next js-only" data-page-turn="1" aria-label="Next page"><span aria-hidden="true">→</span></button>
      <footer class="folio-footer"><span class="footer-credit">© {date.fromisoformat(d['updated']).year} {e(d['name'])}</span>
        <div class="page-indicator" aria-label="Page navigation"><span class="page-status" aria-live="polite" aria-atomic="true">01 / 05</span><span class="keyboard-hint">Click the page edges to turn</span></div>
